...
/** `ballpark_pal` is devig-only (two-way from BP model prices), not a sportsbook column. */
...
export const SKIPPED_BOOK_KEYS = new Set(["polymarket", "bpp_poly", "bpp_flf", "bpp_onl", "bpp_sh"]);
